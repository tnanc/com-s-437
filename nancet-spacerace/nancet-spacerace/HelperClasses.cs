...
{
    /*
     * NOTE: although this is my code, it is adapted from someone else
     * Title: Basic3dExampleCamera.cs
     * Author: willmotil
     * From: https://community.monogame.net/t/fixed-and-free-3d-camera-code-example/11476
     */
    public class ObjectSpace
    {
        ...
        public static float fovInDegrees, nearClip, farClip, aspectRatio;
        public Vector3 Position
        {
            get { return worldSpace.Translation; }
            set { worldSpace.Translation = value; worldSpace = Matrix.CreateWorld(value, Forward, Up); }
        }
        public Vector3 Forward
        {
            get { return worldSpace.Forward; }
            set { worldSpace.Forward = value; worldSpace = Matrix.CreateWorld(Position, value, Up); }
        }
        public Vector3 Up
        {
            get { return upward; }
        ...
        {
            get { return viewSpace; }
            private set { viewSpace = value; }
        }
        ...
        private static void InitializeSpace(GraphicsDevice graphics)
        {
        ...
        public static void RenderView(ObjectSpace camera)
        {
            View = Matrix.CreateLookAt(camera.Position, camera.Forward + camera.Position, camera.Up);
        }

    }
    /*
     * NOTE: THIS CODE DOES NOT BELONG TO ME
     * Title: ConversionHelper.cs
     * Author: @TomTheTornado
